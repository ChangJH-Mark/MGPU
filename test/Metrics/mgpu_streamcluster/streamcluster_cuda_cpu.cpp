                    ...
                    long chunksize, long centersize, char* outfile )
{
    ...
    points.p = static_cast<Point *>(mgpu::cudaMallocHost(chunksize * sizeof(Point)));
    ...
    centers.p = static_cast<Point *>(mgpu::cudaMallocHost(centersize * sizeof(Point)));
    centers.num = 0;
    ...
    while(1) {
        ...
        switch_membership = static_cast<bool*>(mgpu::cudaMallocHost(points.num*sizeof(bool)));
        is_center = (bool*)calloc(points.num,sizeof(bool));
        // cudaMallocHost
        //center_table = (int*)malloc(points.num*sizeof(int));
        center_table = static_cast<int *>(mgpu::cudaMallocHost(points.num * sizeof(int)));
        ...
        free(is_center);
        mgpu::cudaFreeHost(switch_membership);
        mgpu::cudaFreeHost(center_table);
    ...
    switch_membership = static_cast<bool*>(mgpu::cudaMallocHost(centers.num*sizeof(bool)));
    is_center = (bool*)calloc(centers.num,sizeof(bool));
    // cudaMallocHost
    //center_table = (int*)malloc(centers.num*sizeof(int));
    center_table = static_cast<int *>(mgpu::cudaMallocHost(centers.num * sizeof(int)));
